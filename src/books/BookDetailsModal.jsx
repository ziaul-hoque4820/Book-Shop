...
function BookDetailsModal({ book, onClose, onAddToCart }) {
    return (
            ...
            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[420px] sm:max-w-[600px] lg:max-w-[984px] p-4 max-h-[90vh] overflow-auto">
                <div className="bg-white shadow-md dark:bg-[#12141D] rounded-2xl sm:grid sm:grid-cols-[2fr_1fr] overflow-hidden">
                    ...
                    <div className="p-5 lg:p-11">
                        <div className="">
                            <h2 className="text-3xl lg:text-[50px] mb-2 font-bold">{book.name}</h2>
                            <span className="block text-base text-[#9fa0a4] dark:text-[#575A6E] my-3">{book.author}</span>
                        ...
                        <div className="grid lg:grid-cols-2 gap-2">
                            ...
                            <div
                                onClick={onClose}
                                className="border border-[#74766F] cursor-pointer rounded-lg py-2 px-5 flex items-center justify-center gap-2 text-[#6F6F6F] dark:text-gray-200 font-semibold text-sm"
                            >
                                Cancel
                            </div>
                        </div>
